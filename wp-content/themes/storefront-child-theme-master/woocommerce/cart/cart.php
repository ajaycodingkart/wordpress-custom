...
<div class="cart-body">
	<div class="cart_product_cart">
		<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
			<div class="cart_productcart_body">
				<div class="cart_product_body">
				<h2 class="hadding-cart">Cart</h2>
				...
				<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
					<thead>
						<tr>
							...
							<th class="product-price"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?></th>
									...
									<td  data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
										<div class="cart-product-body">
											...
											<div class="product-name">
												...
												?>
												<p class="text-discription">three meals with 2 snacks for 15 days </p>
											</div>
										</div>
									</td>
			...
			<div class="cart_productcart_body">
				<div class="actions">
					...
					<div class="update">
						<button type="submit" class="button btn-theme secondary" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
